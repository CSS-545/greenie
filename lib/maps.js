const GOOGLE_MAPS_API_KEY = 'key'; // Replace with your actual API key
...
async function getSuggestion(partialAddress) {
  ...
  let url = `${baseUrl}/place/autocomplete/json?input=${encodeURIComponent(partialAddress)}&offset=${offset}&key=${GOOGLE_MAPS_API_KEY}`;
